...
function SidebarLogo({ mobile, onClose }: SidebarLogoProps) {
  return (
...
function SidebarNav({ pathname, mobile, onClose }: SidebarNavProps) {
  return (
...
function SidebarUserSection({ onLogout, isLoggingOut }: SidebarUserSectionProps) {
  return (
